...
export const useRestaurantStore = defineStore('restaurants', () => {
  ...
  const getInitialRestaurants = () => [
    { id: 1, name: "Terraço Lisboa Bistrô e Café", cuisine: "Bistrô & Café", location: { lat: -7.0924, lng: -34.8436 }, imageUrl: '/src/assets/images/TerracoLisboa.webp', logoUrl: '/src/assets/images/LogoLisboa.png', galleryUrls: ['/src/assets/images/VistaPrincipalLisboa.jpg', '/src/assets/images/TerracoLisboaNoite.jpg'], menu: [], isNew: false, mapElements: [ { id: 'bar-1', label: 'Bar', x: 10, y: 10, width: 150, height: 40, fill: '#a8a29e', textColor: '#FFFFFF', rx: 5, rotation: 0, icon_svg: '<path d="M12.5 1a1 1 0 0 1 1 1v5.333a2.5 2.5 0 0 1-5 0V2a1 1 0 0 1 1-1h3zm-.5 4.333V2H9.5v3.333a1.5 1.5 0 0 0 3 0z"/><path d="M13 12.5a1 1 0 0 1 1-1h.5a1 1 0 0 1 0 2h-.5a1 1 0 0 1-1-1zm-10 0a1 1 0 0 1 1-1h.5a1 1 0 0 1 0 2H4a1 1 0 0 1-1-1zM5 6a1 1 0 0 1 1-1h5a1 1 0 0 1 0 2H6a1 1 0 0 1-1-1z"/>' } ], tables: [ { id: 1, x: 50, y: 80, width: 40, height: 40, shape: 'round', status: 'available', images: [] } ], floorPatternId: 'floor-marble' },
    { id: 2, name: "Bruttão Burger Bananeiras", cuisine: "Hamburgueria", location: { lat: -7.1195, lng: -34.8256 }, imageUrl: '/src/assets/images/BruttaoBurguerBeco.jpg', logoUrl: '/src/assets/images/BruttaoLogo.png', galleryUrls: ['/src/assets/images/BruttaoLocal.jpg'], menu: [], isNew: false, mapElements: [], tables: [], floorPatternId: 'floor-darkwood' },
    { id: 3, name: "Açaiteria", cuisine: "Açaí & Lanches", location: { lat: -7.1153, lng: -34.8610 }, imageUrl: '/src/assets/images/Acaiteria.jpg', logoUrl: '/src/assets/images/Acaiteria.jpg', galleryUrls: [], menu: [], isNew: false, mapElements: [], tables: [], floorPatternId: 'floor-tiles' },
  ];
