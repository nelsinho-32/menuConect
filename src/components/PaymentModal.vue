<template>
    <div @click.self="$emit('closeModal')"
        ...
        <div class="bg-white rounded-2xl max-w-md w-full shadow-2xl">
            ...
            <div class="p-6">
                ...
                <div class="space-y-3">
                    ...
                    <button @click="selectedPayment = 'local'" :class="getButtonClass('local')"
                        class="payment-option-button w-full flex items-center p-4 rounded-lg border-2">
            ...
            <div class="p-6 bg-gray-50 rounded-b-2xl flex gap-3">
                <button @click="$emit('closeModal')"
                    class="w-full bg-gray-200 text-gray-700 px-6 py-3 rounded-lg font-bold hover:bg-gray-300">Cancelar</button>
                <button @click="$emit('paymentSuccess')"
                    class="w-full bg-green-500 text-white px-6 py-3 rounded-lg font-bold hover:bg-green-600">Confirmar
                    Pedido</button>
                <button @click="$emit('openSplitBill')"
                    class="w-full bg-gray-200 text-gray-700 px-6 py-3 rounded-lg font-bold hover:bg-gray-300">
                    Dividir a Conta
                </button>
            </div>
        </div>
...
defineEmits(['closeModal', 'paymentSuccess', 'openSplitBill']);
